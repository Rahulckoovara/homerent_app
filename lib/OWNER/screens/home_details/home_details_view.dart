...
import 'package:tappal_app/OWNER/screens/home_details/home_details_logic.dart';
...
class OwnerHomeDetails extends StatelessWidget {
  OwnerHomeDetails({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final logic = Get.put(OwnerHomeDetailsLogic());
    return Scaffold(
